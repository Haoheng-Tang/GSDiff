...
os.makedirs('./rplandata/Data/rplang-v3-withsemantics-withboundary/test', exist_ok=True)
os.makedirs('./rplandata/Data/rplang-v3-withsemantics-withboundary-v2/test', exist_ok=True)

...
os.makedirs('./rplandata/Data/rplang-v3-withsemantics-withboundary/train', exist_ok=True)
os.makedirs('./rplandata/Data/rplang-v3-withsemantics-withboundary-v2/train', exist_ok=True)

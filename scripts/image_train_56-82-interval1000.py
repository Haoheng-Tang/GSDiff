'''This is used to train an edge prediction model with sloping walls.'''
...
'''create output_dir'''
output_dir = 'outputs/structure-56-82-interval1000/'
...
'''Data'''
dataset_train = RPlanGEdgeSemanSimplified_82('train')
dataloader_train = DataLoader(dataset_train, batch_size=batch_size, shuffle=True, num_workers=128,
                              drop_last=True, pin_memory=False)  # try different num_workers to be faster
dataloader_train_iter = iter(cycle(dataloader_train))
dataset_val = RPlanGEdgeSemanSimplified_82('val')
dataloader_val = DataLoader(dataset_val, batch_size=1, shuffle=False, num_workers=8,
